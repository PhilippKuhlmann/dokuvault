...
- **Das VLAN-Modal gibt es jetzt auch über der VLAN-Liste**: Es ersetzt dort das bisherige „Neu" und lädt die Liste nach dem Anlegen neu, damit das neue VLAN sofort dasteht, das auf eine eigene Seite führte — sonst stünden zwei Anlegen-Knöpfe nebeneinander. Beide Stellen nutzen dieselbe Komponente, damit das Formular nicht zweimal gepflegt werden muss. Unterschied: Am Gerät erbt das Netz dessen Standort, in der Liste wird er abgefragt — dort gibt ihn nichts vor.

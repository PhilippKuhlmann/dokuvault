...
- **README auf Deutsch und Englisch**: `README.md` bleibt deutsch, `README.en.md` kommt dazu; beide verlinken aufeinander. Screenshots neu aufgenommen, je Sprache ein Satz.

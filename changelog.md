...
- **Globale Suche per Tastatur bedienbar.** Pfeil hoch/runter bewegt die Auswahl über alle Treffer (bereichsübergreifend), Enter öffnet den markierten – ohne die Hand von der Tastatur zu nehmen. Der erste Treffer ist gleich markiert; beim Weitertippen springt die Auswahl zurück an den Anfang.

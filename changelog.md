...
- **Bearbeiten läuft über dasselbe Modal**: Der Stift an einer VLAN-Karte öffnet es mit geladenen Werten, Titel und Knopf wechseln auf „VLAN bearbeiten" und „Speichern". Kein zweites Formular, kein Seitenwechsel — die Liste zeigt die Änderung sofort. Löschen gibt es dort ebenfalls — die Rückfrage erscheint im Modal selbst statt als Browser-Dialog, und der Eintrag landet wie gewohnt im Papierkorb. IP-Adressen behalten dabei ihre VLAN-Zuordnung: Sie zeigen „—", solange das Netz im Papierkorb liegt, und stehen nach dem Wiederherstellen wieder am richtigen VLAN.

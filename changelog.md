...
- **Globale Suche springt zum Treffer.** Ein Klick auf ein Suchergebnis öffnet nicht mehr nur die Liste, sondern scrollt direkt zum gefundenen Gerät und hebt es kurz hervor. Liegt es auf einer späteren Blätter-Seite, springt die Liste dorthin; ein in der Seitenleiste gewählter Standort wird für diesen einen Sprung ausgesetzt, damit der Treffer nicht ausgeblendet bleibt. (Der Treffer wird über den Query-Parameter `?highlight=` übergeben.)

<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-input.fehler :messages="$errors->updatePassword->get('current_password')" class="mt-2" />
        </div>
        ...
        <div>
            ...
            <x-kennwortregel />
            <x-input.fehler :messages="$errors->updatePassword->get('password')" class="mt-2" />
        </div>
        ...
        <div>
            ...
            <x-input.fehler :messages="$errors->updatePassword->get('password_confirmation')" class="mt-2" />
        </div>

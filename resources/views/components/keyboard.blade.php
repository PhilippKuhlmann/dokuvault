{{--
    Globale Tastaturkürzel, die nicht an eine einzelne Seite gebunden sind:
    "/" springt ins Suchfeld (Liste oder Seite), "?" öffnet diese Übersicht.
    Beides greift nur, wenn man nicht gerade in einem Eingabefeld tippt - sonst
    landeten die Zeichen im Feld statt eine Aktion auszulösen.
...
<div x-data="{
        ...
        onKey(e) {
            ...
            else if (e.key === '?') { e.preventDefault(); this.helpOpen = true; }
        },
    }"

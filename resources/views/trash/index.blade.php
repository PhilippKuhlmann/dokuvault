<x-app-layout :$customer>
    ...
    <div class="p-3 sm:p-5">
        <div class="text-2xl font-CoconPro text-gray-900 dark:text-gray-100 mb-4">{{ __('Papierkorb') }}</div>
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs uppercase tracking-wide text-gray-500 bg-gray-50 border-b border-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600">
                    <tr>
                        <th class="py-2.5 px-4 font-semibold">{{ __('Typ') }}</th>
                        <th class="py-2.5 px-4 font-semibold">{{ __('Name') }}</th>
                        <th class="py-2.5 px-4 font-semibold">{{ __('Gelöscht am') }}</th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="py-6 px-4 text-center text-gray-400">{{ __('Der Papierkorb ist leer') }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>

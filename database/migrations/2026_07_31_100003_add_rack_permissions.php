...
/**
 * Bestehende Installationen bekommen die vier Rack-Berechtigungen per Migration
...
return new class extends Migration
{
    private const PERMISSIONS = [
        'rack_viewAny' => 'Rack sehen',
        'rack_create' => 'Rack erstellen',
        'rack_update' => 'Rack bearbeiten',
        'rack_delete' => 'Rack löschen',
    ];

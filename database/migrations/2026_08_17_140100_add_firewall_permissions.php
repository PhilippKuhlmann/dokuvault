...
/**
 * Bestehende Installationen bekommen die vier Firewall-Berechtigungen per
 * Migration (der PermissionRoleSeeder laeuft dort nicht erneut). Admin- und
 * Techniker-Rolle erhalten sie sofort; anderen Rollen weist sie ein Admin
 * ueber die Rollen-Seite zu.
 */
return new class extends Migration
{
    private const PERMISSIONS = [
        'firewall_viewAny' => 'Firewall sehen',
        'firewall_create' => 'Firewall erstellen',
        'firewall_update' => 'Firewall bearbeiten',
